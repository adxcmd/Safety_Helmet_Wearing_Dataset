...
from helmet_detect.segmentation.main import (SegmentationModelInterface, SegmentationModel)
from helmet_detect.drawing.main import (DrawingInterface, Drawing)
