...
from helmet_detect.segmentation.device_manager import DeviceManager
from helmet_detect.segmentation.model_loader import ModelLoader
from helmet_detect.segmentation.models.trash_model import trash_classes
